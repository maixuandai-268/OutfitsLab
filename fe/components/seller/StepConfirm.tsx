        ...
        <div className="bg-white mt-0.5r">
            ...
            <div className=" w-full h-[89px] bg-white flex flex-col justify-center">
                <div className="ml-[473px] flex items-center gap-1">
                    ...
                    <span className="text-[#D19F42]">Xác nhận thông tin</span>
                </div>
            </div>
            <div className="min-h-screen flex flex-col items-center bg-gradient-to-r from-[#FFEAFD] to-[#BFFFF7]">
                <div className="w-16 h-16 mt-10 flex items-center justify-center rounded-full bg-teal-600 text-black">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-circle-check-big-icon lucide-circle-check-big"><path d="M21.801 10A10 10 0 1 1 17 3.335" /><path d="m9 11 3 3L22 4" /></svg>
                </div>
                ...
                <p className="text-gray-500 mt-2">
                    Cửa hàng <span className="font-medium">"dsfasdf"</span> của bạn đã được tạo thành công.
                </p>
                ...
                <div className="flex flex-col gap-4 mt-6 w-[420px]">
                    ...
                    <Link href="/"
                        ...
                        <button
                            type="button"
                            className="flex items-center justify-center gap-2 w-full rounded-full font-medium">
                            Quay lại Trang Chủ
                        </button>
                    </Link>
