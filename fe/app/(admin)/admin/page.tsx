...
import SellerApplicationPage from "@/components/admin/seller/SellerApplicationPage";
  ...
  const renderContent = () => {
    switch (activeNav) {
      ...
      case "Reports":
        ...
        return <SellerApplicationPage dark={dark} />;       // tạm thời dùng ReportPage, bạn sẽ tạo SellerApplicationPage sau
      default:
        return (
          <div
